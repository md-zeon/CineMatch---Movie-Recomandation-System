            ...
            <div class="card bg-base-100 shadow-md hover:shadow-xl transition-shadow duration-300">
                <a href="movie-details.php?id=<?= $movie['id'] ?>">
                    ...
                    <div class="card-body p-4">
                        <h3 class="card-title text-lg font-semibold"><a href="movie-details.php?id=<?= $movie['id'] ?>"
                                class="hover:text-primary transition-colors duration-300"><?= $movie['title'] ?></a></h3>
